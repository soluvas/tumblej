...
bc. install mvn:commons-io/commons-io/2.4
install mvn:org.codehaus.jettison/jettison/1.3.1

jettison is required by jersey-json

h3. Install jersey-client, jersey-json, oauth-signature, oauth-client

bc. install mvn:com.sun.jersey/jersey-core/1.13
